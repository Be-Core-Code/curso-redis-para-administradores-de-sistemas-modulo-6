# Diapositivas del Curso Redis para administradores de sistemas - Módulo 6: Redis Cluster
...
```bash
> docker run --rm -p "8000:8000" becorecode/curso-redis-para-administradores-de-sistemas-modulo-6:latest
```
